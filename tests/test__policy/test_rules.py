...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "subject": {
                    "$.firstName": {"condition": "Equals", "value": "Carl"},
        ...
        (
            {
                ...
                "resource": [
                    {"$.name": {"condition": "Equals", "value": "test"}},
        ...
        ({"subject": {}, "resource": {}, "action": {}, "context": {}}, True),
        ({"subject": [], "resource": [], "action": [], "context": []}, False),
    ],
)
def test_is_satisfied(rules_json, result):
    request_json = {
        "subject": {"id": "a", "attributes": {"firstName": "Carl", "lastName": "Right"}},
        "resource": {"id": "a", "attributes": {"name": "Calendar"}},
