...
class TestPolicy(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            },
            {
                ...
                "targets": {"subject_id": None, "resource_id": ["123"], "action_id": "*"},
                "effect": "deny",
                "priority": 0,
            },
            {
    ...
    @pytest.mark.parametrize(
        "desc, policy_json, request_json, result",
        [
            (
                "Policy 1",
                {
                ...
                {
                    "subject": {"id": "user::b90b2998-9e1b-4ac5-a743-b060b2634dbb", "attributes": {"name": "Max"}},
            ...
            (
                ...
                {
                    "subject": {"id": "user::b90b2998-9e1b-4ac5-a743-b060b2634dbb", "attributes": {"name": "Carl"}},
                    "resource": {"id": "resource::9ce7e474-b16f-4fb1-980e-bd1462bcd5a1"},
                    "action": {"id": "action::GET"},
                    "context": {},
                },
