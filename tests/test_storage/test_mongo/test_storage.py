...
@pytest.mark.parametrize(
    "request_json, num",
    [
        ({"subject": {"id": "a"}, "resource": {"id": str(uuid.uuid4())}, "action": {"id": str(uuid.uuid4())}}, 1),
        ({"subject": {"id": "ab"}, "resource": {"id": str(uuid.uuid4())}, "action": {"id": str(uuid.uuid4())}}, 3),
        ({"subject": {"id": "abc"}, "resource": {"id": str(uuid.uuid4())}, "action": {"id": str(uuid.uuid4())}}, 3),
        ({"subject": {"id": "acb"}, "resource": {"id": str(uuid.uuid4())}, "action": {"id": str(uuid.uuid4())}}, 2),
        ({"subject": {"id": "axc"}, "resource": {"id": str(uuid.uuid4())}, "action": {"id": str(uuid.uuid4())}}, 1),
    ],
)
