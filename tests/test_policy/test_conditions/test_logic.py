...
class TestLogicCondition(object):
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                {
                    "condition": "AllOf",
                    "values": [{"condition": "Gt", "value": 0.0}, {"condition": "Lt", "value": 1.0}],
                },
            ),
            (
                AnyOf([Gt(0.0), Lt(1.0)]),
            ...
            (Not(Gt(1.0)), {"condition": "Not", "value": {"condition": "Gt", "value": 1.0}}),
        ],
    )
    ...
    def test_from_json_not(self):
        ...
        condition_json = {"condition": "Not", "value": {"condition": "Gt", "value": 1.0}}
        new_condition = ConditionSchema().load(condition_json)
