...
from py_abac.policy.conditions.string import NotContains
...
class TestStringCondition(object):
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Contains("2", case_insensitive=True), {"condition": "Contains", "value": "2", "case_insensitive": True}),
            ...
            (Equals("2", case_insensitive=True), {"condition": "Equals", "value": "2", "case_insensitive": True}),
            (NotEquals("2"), {"condition": "NotEquals", "value": "2", "case_insensitive": False}),
            (NotEquals("2", case_insensitive=True), {"condition": "NotEquals", "value": "2", "case_insensitive": True}),
            ...
            (EndsWith("2", case_insensitive=True), {"condition": "EndsWith", "value": "2", "case_insensitive": True}),
