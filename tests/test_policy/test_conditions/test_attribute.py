...
class TestAttributeCondition(object):
    @pytest.mark.parametrize(
        ...
        [
            ...
            (IsInAttribute("subject", "$.teams"), {"condition": "IsInAttribute", "ace": "subject", "path": "$.teams"}),
            (
                IsNotInAttribute("subject", "$.teams"),
                {"condition": "IsNotInAttribute", "ace": "subject", "path": "$.teams"},
            ),
            (AllInAttribute("subject", "$.name"), {"condition": "AllInAttribute", "ace": "subject", "path": "$.name"}),
            (
                AllNotInAttribute("subject", "$.name"),
                {"condition": "AllNotInAttribute", "ace": "subject", "path": "$.name"},
            ),
            (AnyInAttribute("subject", "$.name"), {"condition": "AnyInAttribute", "ace": "subject", "path": "$.name"}),
            (
